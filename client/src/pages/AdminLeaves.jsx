    ...
    return (
        <div className="space-y-6">
            <header className="flex flex-col md:flex-row justify-between items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black text-white mb-1">Touch Grass (Leaves)</h1>
                    <p className="text-zinc-400 text-sm">Manage staff time-off requests.</p>
                </div>
                        ...
                        <div key={item.id} className="glass-card p-5 flex flex-col gap-4 group hover:border-lime-400/30 transition-all">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-zinc-300 font-bold text-lg capitalize">{item.type} Leave</h4>
                                        <div className="flex items-center gap-4 text-xs text-zinc-500 mt-1 font-mono">
                                            ...
                                            <span>•</span>
                                            <span className="text-lime-400 font-bold">{item.days} Days</span>
                                        </div>
                                        {item.reason && (
                                            <p className="text-zinc-500 text-xs mt-2 italic max-w-xl border-l-2 border-zinc-800 pl-3">"{item.reason}"</p>
                                        )}
                                    </div>
                                </div>
