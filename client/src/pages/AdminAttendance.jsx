                ...
                <div className="flex flex-col md:flex-row items-end md:items-center gap-3 w-full md:w-auto">
                    <div className="relative flex-1 w-full md:w-48">
                        ...
                        <input
                            ...
                            className="w-full bg-background border border-input rounded-l px-4 py-2 pl-9 focus:ring-2 focus:ring-primary outline-none text-foreground placeholder-muted-foreground text-sm"
                            value={userFilter}
